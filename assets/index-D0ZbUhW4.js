(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function i(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(a){if(a.ep)return;a.ep=!0;const s=i(a);fetch(a.href,s)}})();const n={name:"Arthur Flávio Gonçalves Araújo",shortName:"Arthur Flávio",initials:"AF",headline:"Estagiário de Suporte Técnico (N1/N3) • Desenvolvedor • Sistemas de Informação — UFU",location:"Uberlândia, MG",email:"arthurflavio06@gmail.com",phone:"+55 34 99228-4560",linkedin:"https://www.linkedin.com/in/arthur-fl%C3%A1vio/",github:"https://github.com/arthurr-arauj",resume:"imagens/Currículo.pdf",photo:"imagens/arthur.jpeg"},u=[{label:"Hyperflow",detail:"Suporte N1/N3"},{label:"ASCII Empresa Júnior",detail:"Diretoria de Projetos"},{label:"Node.js",detail:"APIs REST"},{label:"UFU",detail:"Sistemas de Informação"}],d={summary:"Profissional em formação em Sistemas de Informação, com atuação como Estagiário de Suporte Técnico (N1/N3) e Desenvolvedor na ASCII Empresa Júnior. Experiência com diagnóstico de incidentes complexos, integrações via APIs REST, fluxos de automação e gerenciamento de chamados. Domínio em lógica de programação, metodologias ágeis de alta performance e construção de soluções para processos corporativos.",traits:"Perfil analítico, resiliente e focado em resultados, com atuação em projetos envolvendo arquitetura backend, processamento de dados e evolução contínua em ecossistemas de atendimento.",quickFacts:[{label:"Localização",value:"Uberlândia, MG"},{label:"Formação",value:"Sistemas de Informação — UFU"},{label:"Inglês",value:"Avançado (trabalho e leitura técnica)"},{label:"Português",value:"Nativo"}]},v=[{id:"hyperflow",role:"Estagiário de Suporte Técnico (N1/N3)",company:"Hyperflow",period:"2026 — atual",highlight:!0,bullets:["Atuação na linha de frente da operação, com foco em conversação, integrações e automações.","Organização do fluxo de chamados, documentação de evidências técnicas e investigação de causa-raiz.","Testes e validação de soluções, incluindo consumo de APIs REST via Postman.","Priorização com Kanbanize baseada em SLA, direcionando demandas entre equipes técnicas.","Gestão de chamados críticos com parceiros (Meta/WhatsApp Business) e manutenção de ambientes."]},{id:"ascii",role:"Membro Efetivo (Diretoria de Projetos)",company:"ASCII Empresa Júnior (UFU)",period:"2025 — atual",highlight:!1,bullets:["Ciclo de vida de desenvolvimento de soluções tecnológicas, transformando necessidades em software.","Arquitetura e desenvolvimento de API para leitura, extração e processamento em lote de planilhas Excel.","Rotinas computacionais no backend para catalogação de colunas e recálculo de fórmulas financeiras.","Trabalho colaborativo em equipes multidisciplinares com foco em escopo, prazos e requisitos."]}],g=[{id:"chatbot",title:"Chatbot WhatsApp — Automação e APIs",description:"Assistente virtual interativo com Node.js e Twilio para roteamento de respostas e menus automatizados no WhatsApp.",longDescription:"Chatbot interativo para WhatsApp desenvolvido com Node.js, Express e API da Twilio. Ao receber mensagens, o bot responde com menu numérico interativo para consulta de produtos, promoções e horários.",image:"imagens/demonstracao-chatbot.gif",tags:["Node.js","Express.js","Twilio API","Dotenv","Ngrok"],github:"https://github.com/arthurr-arauj/chatbot-whatsapp-node",demo:null,category:"Automação + APIs"},{id:"focusflow",title:"FocusFlow — Landing Page",description:"Landing page responsiva e performática para processo seletivo da ASCII, com foco em UI/UX e animações suaves.",longDescription:"Desenvolvido como desafio técnico Front-End para o processo seletivo da ASCII (Empresa Júnior de Computação da UFU). Interface com foco total em UI/UX, animações suaves e design responsivo.",image:"imagens/print-site.jpg",tags:["React.js","Tailwind CSS","Vite","React Icons","Vercel"],github:"https://github.com/arthurr-arauj/focusflow-landing-ascii",demo:"https://focusflow-ascii.vercel.app/",category:"Front-end / UI-UX"},{id:"revitalize",title:"Revitalize — Portal Institucional",description:"Portal institucional responsivo para casa de acolhimento de idosos, desenvolvido como projeto de extensão na UFU.",longDescription:"Projeto de extensão da UFU para ajudar uma casa de acolhimento de idosos a divulgar seu trabalho. Desenvolvimento completo com HTML e CSS, aplicando responsividade e personalização visual.",image:"imagens/logo.png",tags:["HTML","CSS","Git","Responsividade"],github:"https://github.com/centro-revitalize/Revitalize",demo:"https://centro-revitalize.github.io/Revitalize/",category:"Projeto social"},{id:"clinica",title:"Clínica Veterinária — Sistema em C",description:"Sistema de gerenciamento para clínica veterinária com structs, CRUDs, ponteiros e persistência em arquivos.",longDescription:"Sistema acadêmico de gerenciamento para clínica veterinária em C. Aplica conceitos de manipulação de arquivos, structs, CRUDs e ponteiros para gerenciamento eficiente de memória.",image:null,tags:["Linguagem C","Estruturas de Dados","Ponteiros","Algoritmos"],github:"https://github.com/arthurr-arauj/sistema-clinica-veterinaria",demo:null,category:"Backend / C"}],h=[{id:"apis",title:"APIs e Integrações",description:"Consumo, testes e automação de fluxos entre sistemas.",items:["APIs REST","Postman","HTTP REST","Automação de fluxos","Integração de sistemas"]},{id:"backend",title:"Backend e Programação",description:"Lógica de negócios e rotinas computacionais.",items:["Node.js","JavaScript","Python","C","C++"]},{id:"frontend",title:"Front-end e UI/UX",description:"Interfaces responsivas e componentizadas.",items:["React","Tailwind CSS","HTML/CSS","Design responsivo"]},{id:"support",title:"Suporte e Processos",description:"Operação técnica e gestão ágil de demandas.",items:["Troubleshooting N1/N3","SLA","Kanbanize","Git/GitHub","Gestão de BD"]}],f=[{degree:"Bacharelado em Sistemas de Informação",institution:"Universidade Federal de Uberlândia",period:"2024 — atualmente",detail:"Previsão de conclusão: Julho/2028"},{degree:"Engenharia de IA, LLMs e Automações",institution:"Alura",period:"2025 — atualmente",detail:"Cursos complementares em inteligência artificial e automações."}],b=[{href:"#sobre",label:"Sobre"},{href:"#experiencia",label:"Experiência"},{href:"#projetos",label:"Projetos"},{href:"#skills",label:"Skills"},{href:"#contato",label:"Contato"}];function m(){return b.map(e=>`<a href="${e.href}" class="site-nav__link" data-section="${e.href.slice(1)}">${e.label}</a>`).join("")}function x(){return u.map(e=>`
      ...
      </li>`).join("")}function w(){return d.quickFacts.map(e=>`
      ...
      </div>`).join("")}function y(){return v.map(e=>`
      ...
      </article>`).join("")}function k(){return g.map(e=>`
      ...
      </article>`).join("")}function S(){return h.map((e,t)=>`
      <article class="interactive-card skill-card reveal p-6" data-skill="${e.id}">
        <div class="relative z-10">
          ...
          <ul class="mt-4 flex flex-wrap gap-2">
            ${e.items.map(i=>`<li class="rounded-lg border border-dark-border bg-dark px-3 py-1.5 text-xs text-[#f5f5f5] transition-colors hover:border-accent hover:text-accent">${i}</li>`).join("")}
          </ul>
        </div>
      </article>`).join("")}function $(){return f.map(e=>`
  ...
  <header class="site-header" role="banner">
    <div class="mx-auto flex h-full max-w-container items-center justify-between px-4 md:px-6">
      <a href="#" class="flex items-center gap-3" aria-label="Início">
        <span class="flex h-10 w-10 items-center justify-center rounded-xl border border-accent/30 bg-accent-soft text-sm font-bold text-accent">${n.initials}</span>
        ...
        <div class="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
          <article class="interactive-card surface-card reveal p-6 md:p-8">
            <div class="relative z-10 space-y-4">
              <p class="text-muted">${d.summary}</p>
              <p class="text-muted">${d.traits}</p>
            </div>
          </article>
...
`;E();A();j();I();L();P();C();T();function E(){const e=document.getElementById("current-year");e&&(e.textContent=String(new Date().getFullYear()))}function A(){document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",t=>{const i=e.getAttribute("href");if(!i||i==="#")return;const o=document.querySelector(i);if(!o)return;t.preventDefault();const a=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--header-height"))||72,s=o.getBoundingClientRect().top+window.scrollY-a-8;window.scrollTo({top:s,behavior:"smooth"}),o.setAttribute("tabindex","-1"),o.focus({preventScroll:!0}),o.addEventListener("blur",()=>o.removeAttribute("tabindex"),{once:!0})})})}function L(){const e=document.getElementById("back-to-top"),t=document.getElementById("footer-back-to-top");if(!e)return;const i=()=>window.scrollTo({top:0,behavior:"smooth"}),o=()=>{e.classList.toggle("is-visible",window.scrollY>600)};window.addEventListener("scroll",o,{passive:!0}),o(),e.addEventListener("click",i),t==null||t.addEventListener("click",i)}function j(){const e=document.querySelector(".site-header"),t=document.querySelector(".nav-toggle"),i=document.querySelectorAll(".site-nav__link"),o=document.getElementById("mobile-nav"),a=document.getElementById("nav-backdrop"),s=document.querySelector(".nav-icon-open"),c=document.querySelector(".nav-icon-close");if(!e||!t||!o)return;const l=r=>{e.classList.toggle("is-nav-open",r),document.body.classList.toggle("menu-open",r),t.setAttribute("aria-expanded",String(r)),t.setAttribute("aria-label",r?"Fechar menu":"Abrir menu"),o.classList.toggle("hidden",!r),o.classList.toggle("flex",r),s==null||s.classList.toggle("hidden",r),c==null||c.classList.toggle("hidden",!r),a==null||a.classList.toggle("is-visible",r)};t.addEventListener("click",()=>{l(!e.classList.contains("is-nav-open"))}),i.forEach(r=>{r.addEventListener("click",()=>{window.innerWidth<=860&&l(!1)})}),a==null||a.addEventListener("click",()=>l(!1)),document.addEventListener("keydown",r=>{r.key==="Escape"&&l(!1)}),window.addEventListener("resize",()=>{window.innerWidth>860&&l(!1)})}function I(){const e=document.querySelector(".site-header");if(!e)return;const t=()=>{e.classList.toggle("is-scrolled",window.scrollY>24)};t(),window.addEventListener("scroll",t,{passive:!0})}function P(){const e=document.querySelectorAll(".reveal");if(!e.length)return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){e.forEach(i=>i.classList.add("is-visible"));return}const t=new IntersectionObserver(i=>{i.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))})},{threshold:.1,rootMargin:"0px 0px -40px 0px"});e.forEach(i=>t.observe(i))}function C(){const e=document.querySelectorAll("section[id]"),t=document.querySelectorAll(".site-nav__link[data-section]");if(!e.length||!t.length)return;const i=s=>{t.forEach(c=>{c.classList.toggle("is-active",c.dataset.section===s)})};let o=!1;const a=()=>{const s=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--header-height"))||72,c=window.scrollY+s+100;let l=null;e.forEach(r=>{r.offsetTop<=c&&(l=r)}),l&&i(l.id),o=!1};window.addEventListener("scroll",()=>{o||(requestAnimationFrame(a),o=!0)},{passive:!0}),a()}function T(){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;document.querySelectorAll(".interactive-card, .surface-card, .project-card, .skill-card, .experience-card, .contact-card, .hero-chip").forEach(t=>{t.addEventListener("mousemove",i=>{const o=t.getBoundingClientRect(),a=i.clientX-o.left,s=i.clientY-o.top,c=o.width/2,l=o.height/2;if(t.style.setProperty("--mouse-x",`${a}px`),t.style.setProperty("--mouse-y",`${s}px`),window.innerWidth>860){const r=(s-l)/l*-2.5,p=(a-c)/c*2.5;t.style.transform=`perspective(800px) rotateX(${r}deg) rotateY(${p}deg) translateY(-4px) scale(1.008)`}}),t.addEventListener("mouseleave",()=>{t.style.transform="",t.style.removeProperty("--mouse-x"),t.style.removeProperty("--mouse-y")}),t.addEventListener("mouseenter",()=>{t.style.transition="border-color 0.3s ease, box-shadow 0.4s ease"}),t.addEventListener("mouseleave",()=>{t.style.transition=""})})}
